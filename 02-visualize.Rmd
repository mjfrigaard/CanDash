...
```{r hide_legend-toWebGL-ggplotly}
plotly::hide_legend(plotly::toWebGL(
      plotly::ggplotly(p = gg_top10_brand_categories)))
```

This tells me `Concentrates` are the most common brand category. I can also see `Flower` and `Edibles` are numbers two and three. 
